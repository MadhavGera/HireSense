          ...
          >
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="border-t border-outline-variant/10 pt-4 space-y-1">
                ...
                <Link href="/dashboard" className="flex items-center gap-3 text-on-surface-variant p-2 hover:bg-surface-bright rounded-lg cursor-pointer transition-colors">
    ...
    <header className="fixed top-0 w-full z-50 flex justify-between items-center px-8 h-16 bg-surface shadow-[0_0_40px_rgba(25,37,64,0.08)]">
      ...
      <div className="flex items-center gap-6">
        <div className="flex gap-4">
          <Bell className="w-5 h-5 text-primary cursor-pointer hover:text-on-surface transition-colors" onClick={() => alert("Opening notifications...")} />
          <Settings className="w-5 h-5 text-primary cursor-pointer hover:text-on-surface transition-colors" onClick={() => alert("Opening settings...")} />
        </div>
        <img
          alt="Recruiter Profile"
          className="w-8 h-8 rounded-full border border-outline-variant/30 object-cover cursor-pointer hover:opacity-80 transition-opacity"
